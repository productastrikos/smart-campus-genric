...
export default function Readiness() {
  ...
  /* ZMU-ONLY MODULE. Readiness & Performance is built entirely around
     ZMU concepts (Garmin/HPO wearables, ACWR injury risk, cadet human
     twin, squadron scoring) and has no Generic equivalent. The nav item
     is hidden in Layout.jsx and the route is blocked in App.jsx, but
     this in-page guard means the module is self-protecting: even if this
     page is reached some other way, Generic Mode never renders military
     content - it redirects home instead. Placed after all hooks so the
     Rules of Hooks are respected. */
  if (isGeneric) return <Navigate to="/" replace />;
