...
/* Passing a falsy path skips the request entirely and leaves data null -
   used by callers that must NOT hit an endpoint at all in a given app
   mode (e.g. Generic Mode not requesting the ZMU-only /readiness feed).
   Existing callers pass a real string and are unaffected. */
