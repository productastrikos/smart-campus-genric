...
export default function LayerControl({
  ...
  // GENERIC MODE: the "Personnel tracking" row itself is never shown, so
  // there's no control surface exposing cadet/people tracking in this
  // mode at all. This only filters what THIS render maps over — the
  // underlying LIVE_LAYERS/ALL_LAYER_KEYS arrays (and therefore ZMU
  // mode's own rendering of this same list) are untouched.
  const liveLayers = isGeneric ? LIVE_LAYERS.filter((l) => l.key !== 'personnel') : LIVE_LAYERS;
  return (
    <div style={{
