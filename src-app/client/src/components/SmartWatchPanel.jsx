      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 12, gap: 8 }}>
        <div>
          <div className="panel-title" style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
            ...
            {isGeneric ? 'Smart Watch — Facilities Team Wellness' : t('exec.watch.title')}
          </div>
          <div className="panel-sub">{isGeneric ? 'Aggregate from smart watch devices issued to facilities staff · wearable health platform' : t('exec.watch.sub')}</div>
        </div>
